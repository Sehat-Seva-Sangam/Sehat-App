...
3. Run the application: `yarn expo start`
4. Install Expo Go app on android.
5. Scan the QR generated by the project and the application will start running on your device.
6. `expo 50` Error. Try these steps `https://docs.expo.dev/workflow/upgrading-expo-sdk-walkthrough/`
